...
class Field
{
     ...
     * @return string
     */
    public static function textEditor($name, $label, $value = null, $required = 'true', $placeholder = null, $disabled = false)
    {
     ...
     * @return string
     */
    public static function fileWithPreview($name, $label, $required = 'true', $old_image = null, $placeholder = null, $disabled = false)
    {
    ...
    public static function toggleBooleanView($name, $label, $model, $url, $disabled = false)
    {
        return view('admin.layouts.partials.form-fields.switch', compact('name', 'label', 'model', 'url', 'disabled'))->render();
    }
}
